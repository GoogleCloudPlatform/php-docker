...
ln -sf ${PHP72_DIR}/bin/php73-enmod ${PHP72_DIR}/bin/php-enmod
ln -sf ${PHP72_DIR}/bin/php73-dismod  ${PHP72_DIR}/bin/php-dismod
${PHP72_DIR}/bin/php73-enmod apcu-bc
${PHP72_DIR}/bin/php73-enmod mailparse
${PHP72_DIR}/bin/php73-enmod memcached
